  ...
  })()(
    {
          ...
          (r.prototype = {
            ...
            keyevent: function (e, t) {
              if (
                e.key &&
                !e.metaKey &&
                -1 === [9, 27, 37, 39, 13, 38, 40].indexOf(e.keyCode)
              ) {
            ...
            getEventPayload: function (e, t) {
              ...
              n = t.options.proximity
                ? [t.options.proximity.longitude, t.options.proximity.latitude]
                : null;
              ...
              return (
                "search.select" === e
                  ? (i.queryString = t.inputString)
                  : "search.select" != e && t._inputEl
                  ? (i.queryString = t._inputEl.value)
                  : (i.queryString = t.inputString),
                i
              );
            },
            ...
            shouldEnableLogging: function (e) {
              return (
                !1 !== e.enableEventLogging &&
                (!e.origin || -1 != e.origin.indexOf("api.mapbox.com")) &&
                !e.localGeocoder &&
                !e.filter
              );
            },
            ...
            push: function (e, t) {
              this.eventQueue.push(e),
                (this.eventQueue.length >= this.maxQueueSize || t) &&
                  this.flush();
            },
            remove: function () {
              this.flush();
      ...
      3: [
        function (e, t, n) {
          ...
          (r.prototype = {
            ...
            onAdd: function (e) {
              if (
                (e && "string" != typeof e && (this._map = e),
                this.setLanguage(),
                this.options.localGeocoderOnly ||
                  (this.geocoderService = c(
                    l({
            ...
            _onKeyDown: function (e) {
              ...
              e.metaKey ||
                -1 !== [9, 27, 37, 39, 13, 38, 40].indexOf(e.keyCode) ||
                (t.value.length >= this.options.minLength &&
                  this._geocode(t.value));
            },
            ...
            _onChange: function () {
              ...
              if (e && JSON.stringify(e) !== this.lastSelected) {
                if (
                  ((this._clearEl.style.display = "none"), this.options.flyTo)
                ) {
                  var t;
            ...
            _geocode: function (e) {
              (this._loadingEl.style.display = "block"),
                this._eventEmitter.emit("loading", { query: e }),
                (this.inputString = e);
              var t,
                n = [
                  "bbox",
                ...
                o = n.reduce(function (e, t) {
                  return (
                    r.options[t] &&
                      (["countries", "types", "language"].indexOf(t) > -1
                        ? (e[t] = r.options[t].split(/[\s,]+/))
                        : (e[t] = r.options[t]),
                      "proximity" === t &&
                        r.options[t] &&
                        "number" == typeof r.options[t].longitude &&
                        "number" == typeof r.options[t].latitude &&
                        (e[t] = [
                          r.options[t].longitude,
                          r.options[t].latitude,
                        ])),
                    e
                  );
                }, {});
              ...
              var u = [];
              this.options.localGeocoder &&
                ((u = this.options.localGeocoder(e)) || (u = []));
              var l = [];
              return (
                t
                  .catch(
                    ...
                    function (t) {
                      ...
                      return (
                        ...
                        this.options.externalGeocoder
                          ? ((l =
                              this.options.externalGeocoder(e, n.features) ||
                              []),
                            l.then(
                              function (e) {
                                return (
                  ...
                  .then(
                    function (e) {
                      ...
                      this.options.filter &&
                        e.features.length &&
                        (e.features = e.features.filter(this.options.filter)),
                        e.features.length
                          ? ((this._clearEl.style.display = "block"),
                            this._eventEmitter.emit("results", e),
                            this._typeahead.update(e.features))
                          : ((this._clearEl.style.display = "none"),
                  ...
                  .catch(
                    function (e) {
                      (this._loadingEl.style.display = "none"),
                        (u.length && this.options.localGeocoder) ||
                        (l.length && this.options.externalGeocoder)
                          ? ((this._clearEl.style.display = "block"),
                            this._typeahead.update(u))
                          : ((this._clearEl.style.display = "none"),
                            (this._typeahead.selected = null),
                            this._renderError()),
                        this._eventEmitter.emit("results", { features: u }),
                        this._eventEmitter.emit("error", { error: e });
                    }.bind(this)
                  ),
                t
              );
            ...
            setRenderFunction: function (e) {
              return (
                e && "function" == typeof e && (this._typeahead.render = e),
                this
              );
            },
            ...
            setLanguage: function (e) {
              ...
              return (
                (this.options.language = e || this.options.language || t), this
              );
            },
            ...
            setPlaceholder: function (e) {
              return (
                (this.placeholder = e || this._getPlaceholderText()),
      ...
      5: [
        function (e, t, n) {
          ...
          function c(e) {
            return (
              "number" == typeof e[e.length - 1] || "number" == typeof e[0]
            );
          }
          function h(e) {
          ...
          (m.assert = function (e, t) {
            return (
              ...
              function (n) {
                ...
                if (r) {
                  var s = o(r, t);
                  throw (t.apiName && (s = t.apiName + ": " + s), new Error(s));
                }
              }
            );
          }),
              ...
              function t(t) {
                return null == t
                  ? function (e) {
                      return l(
                        e,
                        c(e.path) ? "cannot be undefined/null." : "is required."
                      );
                    }
            ...
            (m.oneOfType = function () {
              var e = Array.isArray(arguments[0])
                ? arguments[0]
                : Array.prototype.slice.call(arguments);
              return function (t) {
                var n = e
      ...
      7: [
        ...
        { "../classes/mapi-client": 9, "./browser-layer": 8 },
      ],
      8: [
        function (e, t, n) {
          "use strict";
        ...
        function (e, t, n) {
          ...
          (r.prototype.url = function (e) {
            ...
            (r.prototype.send = function () {
              ...
              return (
                (e.sent = !0),
                e.client.sendRequest(e).then(
                  function (t) {
                    return (
                      (e.response = t), e.emitter.emit(u.EVENT_RESPONSE, t), t
                    );
                  },
                  function (t) {
          ...
          function o(e) {
            return e
              ? e.split(/,\s*</).reduce(function (e, t) {
                  var n = i(t);
                  return n
                    ? (n.rel.split(/\s+/).forEach(function (t) {
      ...
      16: [
        function (e, t, n) {
          ...
          function u(e, t) {
            return t
              ? e.replace(/\/:([a-zA-Z0-9]+)/g, function (e, n) {
                  var r = t[n];
                  if (void 0 === r)
      ...
      18: [
        ...
        { "../../lib/classes/mapi-client": 9, "../../lib/client": 7 },
      ],
      19: [
        function (e, t, n) {
          "use strict";
          ...
          (function (t) {
            !(function (i) {
              ...
              if ("function" == typeof e && "object" == typeof e.amd && e.amd)
                ...
                if (s) s.exports = d;
                else for (var m in d) d.hasOwnProperty(m) && (o[m] = d[m]);
              else i.base64 = d;
            })(this);
          }.call(
            this,
            ...
            if (
              ...
              s
                ? (s.newListener &&
                    ...
                    (s = e._events)),
                  (a = s[t]))
                : ((s = e._events = x(null)), (e._eventsCount = 0)),
              a)
            ) {
              if (
                ("function" == typeof a
        ...
        function (e, t, n) {
          ...
          function o(e, t, n, r, o) {
            ...
            return (
              e._events[a]
                ? e._events[a].fn
                  ? (e._events[a] = [e._events[a], s])
                  : e._events[a].push(s)
                : ((e._events[a] = s), e._eventsCount++),
              e
            );
          }
          function s(e, t) {
          ...
          Object.create &&
            ...
            (a.prototype.removeAllListeners = function (e) {
              ...
              return (
                e
                  ? ((t = l ? l + e : e), this._events[t] && s(this, t))
                  : ((this._events = new r()), (this._eventsCount = 0)),
                this
              );
            }),
          ...
          (function (e) {
            function n(e, t, n) {
              function i(t) {
                var n = m,
                  r = g;
                return (m = g = void 0), (O = t), (v = e.apply(r, n));
              }
              function o(e) {
                return (O = e), (b = setTimeout(c, t)), L ? i(e) : v;
              }
              function u(e) {
                var n = e - E,
                  r = e - O,
              ...
              function h(e) {
                return (b = void 0), T && m ? i(e) : ((m = g = void 0), v);
              }
              function p() {
              ...
              function d() {
                var e = w(),
                  n = l(e);
                if (((m = arguments), (g = this), (E = e), n)) {
                  if (void 0 === b) return o(E);
                  if (k) return (b = setTimeout(c, t)), i(E);
                }
                return void 0 === b && (b = setTimeout(c, t)), v;
              }
              var m,
                g,
                y,
        ...
        function (e, t, n) {
          (function (e) {
            ...
            t.exports = function (e) {
              e = e || 21;
              for (
                var t = "", r = n.getRandomValues(new Uint8Array(e));
                0 < e--;
        ...
        function (e, t, n) {
          ...
          var r = e("xtend"),
            ...
            s = function (e, t, n) {
              return (
                (n = n || {}),
                (this.options = r({ minLength: 2, limit: 5, filter: !0 }, n)),
                (this.el = e),
                (this.data = t || []),
          ...
          (s.prototype.handleKeyUp = function (e) {
            ...
            (s.prototype.handleKeyDown = function (e) {
              switch (e.keyCode) {
                ...
                case 9:
                  this.list.isEmpty() ||
                    (this.list.isVisible() && e.preventDefault(),
              ...
              this.getCandidates(
                function (e) {
                  for (
                    var t = 0;
                    t < e.length &&
                    (this.list.add(e[t]), t !== this.options.limit - 1);
                    t++
                  );
                  this.list.draw();
                }.bind(this)
            ...
            (s.prototype.getCandidates = function (e) {
              ...
              this.options.filter
                ? ((t = i.filter(this.query, this.data, n)),
                  (t = t.map(
                    function (e) {
                      return {
                        original: e.original,
